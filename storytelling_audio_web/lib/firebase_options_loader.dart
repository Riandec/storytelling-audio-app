...
class DefaultFirebaseOptions {
  ...
  static FirebaseOptions get macos {
    return FirebaseOptions(
      apiKey: _getRequired('API_KEY_MACOS'),
      appId: _getRequired('APP_ID_MACOS'),
      messagingSenderId: _getRequired('MESSAGING_SENDER_ID_MACOS'),
      projectId: _getRequired('PROJECT_ID_MACOS'),
      storageBucket: _getRequired('STORAGE_BUCKET_MACOS'),
      iosBundleId: _getRequired('IOS_BUNDLE_ID'),
    );
  }
  ...
  static FirebaseOptions get windows {
    return FirebaseOptions(
      apiKey: _getRequired('API_KEY_WINDOW'),
      appId: _getRequired('APP_ID_WINDOW'),
      messagingSenderId: _getRequired('MESSAGING_SENDER_ID_WINDOW'),
      projectId: _getRequired('PROJECT_ID_WINDOW'),
      authDomain: _getRequired('AUTH_DOMAIN_WINDOW'),
      storageBucket: _getRequired('STORAGE_BUCKET_WINDOW'),
      measurementId: _getRequired('MEASUREMENT_ID_WINDOW'),
    );
  }
}